...
from lib.response import (BadRequestResponse, ConflictResponse,
                          ...
                          UnprocEntityResponse, UnsupportedMediaTypeResponse)
...
class UnsupportedMediaTypeResponseSchema(BaseResponseSchema):
    status = Constant(UnsupportedMediaTypeResponse.status())
    error = Constant(UnsupportedMediaTypeResponse.error)
    code = Constant(UnsupportedMediaTypeResponse.code)

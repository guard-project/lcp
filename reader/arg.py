...
class ArgReader:
    ...
    def init(cls):
        cls.cr = ConfigReader()
        cls.cr.read()
        cls.ap = ArgumentParser(prog='python3 main.py',
        ...
        add('--polycube-host', '-s', type=str, help='Hostname/IP of Polycube',
            default=cls.cr.polycube_host)
        add('--polycube-port', '-c', type=int, help='Port of Polycube',
            default=cls.cr.polycube_port)
        add('--polycube-timeout', '-e', type=str,
